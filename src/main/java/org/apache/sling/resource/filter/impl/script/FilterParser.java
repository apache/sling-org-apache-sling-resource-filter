...
{if ("" != null) return nodes.size() != 1 ? new Node(FilterParserConstants.OR, nodes) : nodes.get(0);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return nodes.size() != 1 ? new Node(FilterParserConstants.AND, nodes) : nodes.get(0);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return node;}
  ...
  final public Node comparison() throws ParseException {Node leftValue;
  Token op;
  Node rightValue;
    leftValue = argument();
    op = comparisonValue();
    rightValue = argument();
{if ("" != null) return new Node(op.kind, op.image, leftValue, rightValue);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return token;}
  ...
  final public List < Node > Arguments() throws ParseException {Object value = new ArrayList();
    jj_consume_token(LPAREN);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OFFSETDATETIME:
    case DATETIME:
...
{if ("" != null) return (List) value;}
  ...
  final public List < Node > commaSepArguments() throws ParseException {final List < Node > list = new ArrayList < Node > (3);
  Node arg;
    arg = argument();
list.add(arg);
    label_3:
...
{if ("" != null) return list;}
  ...
  final public Node argument() throws ParseException {Node selector = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OFFSETDATETIME:
    case DATETIME:
    case DATE:
...
{if ("" != null) return selector;}
  ...
  final public Node function() throws ParseException {String functionName = null;
...
functionName = token.image;
    ...
    jj_consume_token(RPAREN);
{if ("" != null) return new Node(FilterParserConstants.FUNCTION_NAME, functionName, children);}
    throw new Error("Missing return statement in function");
}

  final public Node dynamicArg() throws ParseException {String functionName = null;
    jj_consume_token(DYNAMIC_ARG);
    jj_consume_token(FUNCTION_NAME);
functionName = token.image;
    {if ("" != null) return new Node(FilterParserConstants.DYNAMIC_ARG, functionName);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return new Node(token.kind, token.image);}
    throw new Error("Missing return statement in function");
}
